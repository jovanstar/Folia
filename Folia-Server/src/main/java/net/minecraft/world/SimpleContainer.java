...
public class SimpleContainer implements Container, StackedContentsCompatible {
    ...
    public boolean canAddItem(ItemStack stack) {
        ...
        while (iterator.hasNext()) {
            ...
            if (itemstack1.isEmpty() || ItemStack.isSameItemSameComponents(itemstack1, stack) && itemstack1.getCount() < itemstack1.getMaxStackSize()) {
                flag = true;
                break;
            }
        }
    ...
    private void moveItemToOccupiedSlotsWithSameType(ItemStack stack) {
        for (int i = 0; i < this.size; ++i) {
            ...
            if (ItemStack.isSameItemSameComponents(itemstack1, stack)) {
