...
public record FallLocation(String id) {
    ...
    public static FallLocation getCurrentFallLocation(LivingEntity entity) {
        ...
        if (optional.isPresent() && ca.spottedleaf.moonrise.common.util.TickThread.isTickThreadFor((net.minecraft.server.level.ServerLevel)entity.level(), optional.get())) { // Folia - region threading
