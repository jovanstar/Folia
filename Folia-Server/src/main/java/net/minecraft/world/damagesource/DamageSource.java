...
public class DamageSource {
    ...
    public Component getLocalizedDeathMessage(LivingEntity killed) {
        ...
        if (this.causingEntity == null && this.directEntity == null) {
            ...
            return entityliving1 != null && ca.spottedleaf.moonrise.common.util.TickThread.isTickThreadFor(entityliving1) ? Component.translatable(s1, killed.getDisplayName(), entityliving1.getDisplayName()) : Component.translatable(s, killed.getDisplayName()); // Folia - region threading
        } else {
            ...
            if (entity instanceof LivingEntity livingEntity && ca.spottedleaf.moonrise.common.util.TickThread.isTickThreadFor(livingEntity)) { // Folia - region threading
