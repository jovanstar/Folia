...
public class BlockCollisions<T> extends AbstractIterator<T> {
    ...
    public BlockCollisions(
        ...
        this(world, entity == null ? CollisionContext.empty() : CollisionContext.of(entity), box, forEntity, resultFunction);
    }

    public BlockCollisions(
        CollisionGetter world, CollisionContext context, AABB box, boolean forEntity, BiFunction<BlockPos.MutableBlockPos, VoxelShape, T> resultFunction
    ) {
