...
public class FlatLevelSource extends ChunkGenerator {
    ...
    public int getSpawnHeight(LevelHeightAccessor world) {
        return world.getMinY() + Math.min(world.getHeight(), this.settings.getLayers().size());
    }
    ...
    public NoiseColumn getBaseColumn(int x, int z, LevelHeightAccessor world, RandomState noiseConfig) {
        return new NoiseColumn(world.getMinY(), (BlockState[]) this.settings.getLayers().stream().limit((long) world.getHeight()).map((iblockdata) -> {
