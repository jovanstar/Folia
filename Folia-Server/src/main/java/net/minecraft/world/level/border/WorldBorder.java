...
public class WorldBorder {
    ...
    public Vec3 clampVec3ToBound(Vec3 pos) {
        return this.clampVec3ToBound(pos.x, pos.y, pos.z);
    }

    public Vec3 clampVec3ToBound(double x, double y, double z) {
        return new Vec3(Mth.clamp(x, this.getMinX(), this.getMaxX() - 9.999999747378752E-6D), y, Mth.clamp(z, this.getMinZ(), this.getMaxZ() - 9.999999747378752E-6D));
    }
