...
public class JigsawBlockEntity extends BlockEntity {
    ...
    protected void loadAdditional(CompoundTag nbt, HolderLookup.Provider registries) {
        ...
        this.target = ResourceLocation.parse(nbt.getString("target"));
        this.pool = ResourceKey.create(Registries.TEMPLATE_POOL, ResourceLocation.parse(nbt.getString("pool")));
        this.finalState = nbt.getString("final_state");
        this.joint = StructureTemplate.getJointType(nbt, this.getBlockState());
