    ...
    public static class OceanRuinPiece extends TemplateStructurePiece {
            ...
            if ("chest".equals(metadata)) {
                ...
                */
                ...
                if (entitydrowned != null) {
                    ...
                    entitydrowned.finalizeSpawn(world, world.getCurrentDifficultyAt(pos), EntitySpawnReason.STRUCTURE, (SpawnGroupData) null);
        ...
        private int getHeight(BlockPos start, BlockGetter world, BlockPos end) {
            ...
            while (iterator.hasNext()) {
                ...
                for (FluidState fluid = world.getFluidState(blockposition_mutableblockposition); (iblockdata.isAir() || fluid.is(FluidTags.WATER) || iblockdata.is(BlockTags.ICE)) && k1 > world.getMinY() + 1; fluid = world.getFluidState(blockposition_mutableblockposition)) {
                    --k1;
