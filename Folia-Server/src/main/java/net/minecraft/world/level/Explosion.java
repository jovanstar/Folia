...
public interface Explosion {
    static DamageSource getDefaultDamageSource(Level world, @Nullable Entity source) {
        return world.damageSources().explosion(source, getIndirectSourceEntity(source));
    }

    @Nullable
    static LivingEntity getIndirectSourceEntity(@Nullable Entity entity) {
        return switch (entity) {
            // Folia - decompile error - move down
            ...
            case null, default -> null; // Folia - decompile error - moved down
        };
    }
    ...
    public static enum BlockInteraction {
        ...
        private BlockInteraction(final boolean destroysBlocks) {
            this.shouldAffectBlocklikeEntities = destroysBlocks;
        }
