...
public abstract class BlockEntity {
    ...
    public final void loadCustomOnly(CompoundTag nbt, HolderLookup.Provider registries) {
        this.loadAdditional(nbt, registries);
    }
    ...
    public final CompoundTag saveWithFullMetadata(HolderLookup.Provider registries) {
        CompoundTag nbttagcompound = this.saveWithoutMetadata(registries);
    ...
    public final CompoundTag saveWithoutMetadata(HolderLookup.Provider registries) {
        ...
        BlockEntity.ComponentHelper.COMPONENTS_CODEC.encodeStart(registries.createSerializationContext(NbtOps.INSTANCE), this.components).resultOrPartial((s) -> {
    ...
    @Nullable
    public static BlockEntity loadStatic(BlockPos pos, BlockState state, CompoundTag nbt, HolderLookup.Provider registries) {
        ...
        if (minecraftkey == null) {
            ...
            return (BlockEntity) BuiltInRegistries.BLOCK_ENTITY_TYPE.getOptional(minecraftkey).map((tileentitytypes) -> {
                ...
                try {
                    tileentity.loadWithComponents(nbt, registries);
                    return tileentity;
                } catch (Throwable throwable) {
