...
public class Frog extends Animal implements VariantHolder<Holder<FrogVariant>> {
    ...
    public AgeableMob getBreedOffspring(ServerLevel world, AgeableMob entity) {
        Frog frog = EntityType.FROG.create(world, EntitySpawnReason.BREEDING);
        if (frog != null) {
    ...
    public static boolean checkFrogSpawnRules(
        EntityType<? extends Animal> type, LevelAccessor world, EntitySpawnReason reason, BlockPos pos, RandomSource random
    ) {
