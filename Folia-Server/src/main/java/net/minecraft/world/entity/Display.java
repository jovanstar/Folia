...
public abstract class Display extends Entity {
    ...
    protected void readAdditionalSaveData(CompoundTag nbt) {
        ...
        if (nbt.contains("billboard", 8)) {
            Display.BillboardConstraints.CODEC
                ...
                .resultOrPartial(Util.prefix("Display entity", LOGGER::error))
                .ifPresent(pair -> this.setBillboardConstraints(pair.getFirst()));
        }
        ...
        if (nbt.contains("brightness", 10)) {
            Brightness.CODEC
                ...
                .resultOrPartial(Util.prefix("Display entity", LOGGER::error))
                .ifPresent(pair -> this.setBrightnessOverride(pair.getFirst()));
        } else {
    ...
    protected void addAdditionalSaveData(CompoundTag nbt) {
        ...
        Display.BillboardConstraints.CODEC.encodeStart(NbtOps.INSTANCE, this.getBillboardConstraints()).ifSuccess(billboard -> nbt.put("billboard", billboard));
    ...
    public static enum BillboardConstraints implements StringRepresentable {
        ...
        private BillboardConstraints(final byte index, final String name) {
            this.name = name;
            this.id = index;
        }
        ...
        protected void readAdditionalSaveData(CompoundTag nbt) {
            ...
            if (nbt.contains("item_display", 8)) {
                ItemDisplayContext.CODEC
                    ...
                    .ifPresent(mode -> this.setItemTransform(mode.getFirst()));
            }
        }
    ...
    public static class TextDisplay extends Display {
        ...
        protected void addAdditionalSaveData(CompoundTag nbt) {
            super.addAdditionalSaveData(nbt);
            nbt.putString("text", Component.Serializer.toJson(this.getText(), this.registryAccess()));
            ...
            Display.TextDisplay.Align.CODEC.encodeStart(NbtOps.INSTANCE, getAlign(b)).ifSuccess(tag -> nbt.put("alignment", tag));
        }
