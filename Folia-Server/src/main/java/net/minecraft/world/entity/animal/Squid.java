...
public class Squid extends AgeableWaterCreature {
    ...
    public AgeableMob getBreedOffspring(ServerLevel world, AgeableMob entity) {
        return EntityType.SQUID.create(world, EntitySpawnReason.BREEDING);
    }
    ...
    public boolean hurtServer(ServerLevel world, DamageSource source, float amount) {
        if (super.hurtServer(world, source, amount) && this.getLastHurtByMob() != null) {
            this.spawnInk();
            return true;
        } else {
            return false;
    ...
    private Vec3 rotateVector(Vec3 shootVector) {
        Vec3 vec3 = shootVector.xRot(this.xBodyRotO * (float) (Math.PI / 180.0));
    ...
    public SpawnGroupData finalizeSpawn(
        ...
        SpawnGroupData spawnGroupData = Objects.requireNonNullElseGet(entityData, () -> new AgeableMob.AgeableMobGroupData(0.05F));
    ...
    class SquidFleeGoal extends Goal {
        ...
        public boolean canUse() {
            ...
            return Squid.this.isInWater() && livingEntity != null && Squid.this.distanceToSqr(livingEntity) < 100.0;
        }
