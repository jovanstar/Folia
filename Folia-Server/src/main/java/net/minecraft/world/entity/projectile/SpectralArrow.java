...
public class SpectralArrow extends AbstractArrow {
    ...
    public SpectralArrow(Level world, LivingEntity owner, ItemStack stack, @Nullable ItemStack shotFrom) {
        super(EntityType.SPECTRAL_ARROW, owner, world, stack, shotFrom);
    }

    public SpectralArrow(Level world, double x, double y, double z, ItemStack stack, @Nullable ItemStack shotFrom) {
