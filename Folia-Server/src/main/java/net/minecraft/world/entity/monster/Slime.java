...
public class Slime extends Mob implements Enemy {
    ...
    protected void dealDamage(LivingEntity target) {
        ...
        if (world instanceof ServerLevel worldserver) {
            if (this.isAlive() && this.isWithinMeleeAttackRange(target) && this.hasLineOfSight(target)) {
                ...
                if (target.hurtServer(worldserver, damagesource, this.getAttackDamage())) {
    ...
    public static boolean checkSlimeSpawnRules(EntityType<Slime> type, LevelAccessor world, EntitySpawnReason spawnReason, BlockPos pos, RandomSource random) {
