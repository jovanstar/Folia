...
public class TemptGoal extends Goal {
    ...
    public TemptGoal(PathfinderMob entity, double speed, Predicate<ItemStack> foodPredicate, boolean canBeScared) {
        this.mob = entity;
        this.speedModifier = speed;
        this.items = foodPredicate;
        this.canScare = canBeScared;
        this.setFlags(EnumSet.of(Goal.Flag.MOVE, Goal.Flag.LOOK));
        this.targetingConditions = TemptGoal.TEMPT_TARGETING.copy().selector((entityliving, worldserver) -> {
