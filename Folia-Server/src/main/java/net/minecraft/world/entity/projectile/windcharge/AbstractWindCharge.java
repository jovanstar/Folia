...
public abstract class AbstractWindCharge extends AbstractHurtingProjectile implements ItemSupplier {
    ...
    protected AABB makeBoundingBox(Vec3 pos) {
        ...
        return new AABB(pos.x - (double) f, pos.y - 0.15000000596046448D, pos.z - (double) f, pos.x + (double) f, pos.y - 0.15000000596046448D + (double) f1, pos.z + (double) f);
    }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (world instanceof ServerLevel worldserver) {
            ...
            if (entity1.hurtServer(worldserver, damagesource, 1.0F) && entity1 instanceof LivingEntity entityliving3) {
