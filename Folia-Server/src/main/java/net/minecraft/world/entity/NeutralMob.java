...
public interface NeutralMob {
    ...
    default boolean isAngryAt(LivingEntity entity, ServerLevel world) {
    ...
    default boolean isAngryAtAllPlayers(ServerLevel world) {
    ...
    default void playerDied(ServerLevel world, Player player) {
        if (world.getGameRules().getBoolean(GameRules.RULE_FORGIVE_DEAD_PLAYERS)) {
