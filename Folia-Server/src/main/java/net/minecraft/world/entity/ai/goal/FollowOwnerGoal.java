...
public class FollowOwnerGoal extends Goal {
    ...
    public boolean canContinueToUse() {
        return !this.navigation.isDone()
            ...
            && !(this.owner.level() == this.tamable.level() && this.tamable.distanceToSqr(this.owner) <= (double)(this.stopDistance * this.stopDistance)); // Folia - region threading - check level
    }
