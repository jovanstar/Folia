...
public class FireworkRocketEntity extends Projectile implements ItemSupplier {
    ...
    private void dealExplosionDamage(ServerLevel world) {
        float f = 0.0F;
        ...
        if (f > 0.0F) {
            if (this.attachedToEntity != null) {
                this.attachedToEntity.hurtServer(world, this.damageSources().fireworks(this, this.getOwner()), 5.0F + (float) (list.size() * 2));
            }
            ...
            while (iterator.hasNext()) {
                ...
                if (entityliving != this.attachedToEntity && this.distanceToSqr((Entity) entityliving) <= 25.0D) {
                    ...
                    if (flag) {
                        ...
                        entityliving.hurtServer(world, this.damageSources().fireworks(this, this.getOwner()), f1);
                    }
                }
            }
        }
