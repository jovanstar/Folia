...
public class DefendVillageTargetGoal extends TargetGoal {
    ...
    public boolean canUse() {
        ...
        ServerLevel worldserver = getServerLevel((Entity) this.golem);
        List<? extends LivingEntity> list = worldserver.getNearbyEntities(Villager.class, this.attackTargeting, this.golem, axisalignedbb);
