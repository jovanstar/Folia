...
public class VillageSiege implements CustomSpawner {
    ...
    public int tick(ServerLevel world, boolean spawnMonsters, boolean spawnAnimals) {
        ...
        if (worldData.villageSiegeState.siegeState != State.SIEGE_DONE
            && !ca.spottedleaf.moonrise.common.util.TickThread.isTickThreadFor(world, worldData.villageSiegeState.spawnX >> 4, worldData.villageSiegeState.spawnZ >> 4, 8)) {
    ...
    private Vec3 findRandomSpawnPos(ServerLevel world, BlockPos pos) {
        for (int i = 0; i < 10; ++i) {
            ...
            if (world.isVillage(blockposition1) && Monster.checkMonsterSpawnRules(EntityType.ZOMBIE, world, EntitySpawnReason.EVENT, blockposition1, world.random)) {
