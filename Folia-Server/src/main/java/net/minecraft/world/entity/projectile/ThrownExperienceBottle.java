...
public class ThrownExperienceBottle extends ThrowableItemProjectile {
    ...
    public ThrownExperienceBottle(Level world, LivingEntity owner, ItemStack stack) {
        super(EntityType.EXPERIENCE_BOTTLE, owner, world, stack);
    }

    public ThrownExperienceBottle(Level world, double x, double y, double z, ItemStack stack) {
