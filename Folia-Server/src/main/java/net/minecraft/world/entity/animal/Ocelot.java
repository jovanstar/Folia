...
public class Ocelot extends Animal {
    ...
    public Ocelot getBreedOffspring(ServerLevel world, AgeableMob entity) {
        return (Ocelot) EntityType.OCELOT.create(world, EntitySpawnReason.BREEDING);
    }
    ...
    public static boolean checkOcelotSpawnRules(EntityType<Ocelot> type, LevelAccessor world, EntitySpawnReason spawnReason, BlockPos pos, RandomSource random) {
