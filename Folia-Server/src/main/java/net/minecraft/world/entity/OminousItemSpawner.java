...
public class OminousItemSpawner extends Entity {
    ...
    private void tickServer(ServerLevel world) {
        if ((long)this.tickCount == this.spawnItemAfterTicks - 36L) {
            world.playSound(null, this.blockPosition(), SoundEvents.TRIAL_SPAWNER_ABOUT_TO_SPAWN_ITEM, SoundSource.NEUTRAL);
        }
    ...
    private Entity spawnProjectile(ServerLevel world, ProjectileItem item, ItemStack stack) {
