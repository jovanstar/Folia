...
public class AreaEffectCloud extends Entity implements TraceableEntity {
    ...
    public void updateColor() {
        ...
        if (particleparam instanceof ColorParticleOption colorparticleoption) {
            ...
            this.entityData.set(AreaEffectCloud.DATA_PARTICLE, ColorParticleOption.create(colorparticleoption.getType(), ARGB.opaque(i)));
        }
                    ...
                    if (!this.potionContents.hasEffects()) {
                        ...
                        if (this.potionContents.potion().isPresent()) {
                            ...
                            while (iterator.hasNext()) {
                                ...
                                list.add(new MobEffectInstance(mobeffect.getEffect(), mobeffect.mapDuration((i) -> {
                                    return i / 4;
