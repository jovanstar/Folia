...
public class Goat extends Animal {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Animal.createAnimalAttributes().add(Attributes.MAX_HEALTH, 10.0D).add(Attributes.MOVEMENT_SPEED, 0.20000000298023224D).add(Attributes.ATTACK_DAMAGE, 2.0D);
    }
    ...
    public Goat getBreedOffspring(ServerLevel world, AgeableMob entity) {
        Goat goat = (Goat) EntityType.GOAT.create(world, EntitySpawnReason.BREEDING);
