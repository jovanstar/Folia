...
public class AABB {
    ...
    public AABB move(Vector3f offset) {
        return this.move((double)offset.x, (double)offset.y, (double)offset.z);
    }
    ...
    public boolean collidedAlongVector(Vec3 vec3, List<AABB> boundingBoxes) {
