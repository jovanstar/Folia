...
public class AxeItem extends DiggerItem {
    ...
    public AxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Properties settings) {
        super(material, BlockTags.MINEABLE_WITH_AXE, attackDamage, attackSpeed, settings);
    }
