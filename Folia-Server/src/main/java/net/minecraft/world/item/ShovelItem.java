...
public class ShovelItem extends DiggerItem {
    ...
    public ShovelItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Properties settings) {
        super(material, BlockTags.MINEABLE_WITH_SHOVEL, attackDamage, attackSpeed, settings);
    }
