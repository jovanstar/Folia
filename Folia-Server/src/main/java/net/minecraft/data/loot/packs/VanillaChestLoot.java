...
public record VanillaChestLoot(HolderLookup.Provider registries) implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
        ...
        lootTableBiConsumer.accept(BuiltInLootTables.BASTION_BRIDGE, this.bastionBridgeLootTable());
        lootTableBiConsumer.accept(BuiltInLootTables.BASTION_HOGLIN_STABLE, this.bastionHoglinStableLootTable());
        lootTableBiConsumer.accept(BuiltInLootTables.BASTION_OTHER, this.bastionOtherLootTable());
        lootTableBiConsumer.accept(BuiltInLootTables.BASTION_TREASURE, this.bastionTreasureLootTable());
        lootTableBiConsumer.accept(
        ...
        lootTableBiConsumer.accept(BuiltInLootTables.ANCIENT_CITY, this.ancientCityLootTable());
        lootTableBiConsumer.accept(
        ...
        lootTableBiConsumer.accept(BuiltInLootTables.DESERT_PYRAMID, this.desertPyramidLootTable());
        lootTableBiConsumer.accept(BuiltInLootTables.END_CITY_TREASURE, this.endCityTreasureLootTable());
        lootTableBiConsumer.accept(
        ...
        lootTableBiConsumer.accept(BuiltInLootTables.JUNGLE_TEMPLE, this.jungleTempleLootTable());
        lootTableBiConsumer.accept(
        ...
        lootTableBiConsumer.accept(BuiltInLootTables.NETHER_BRIDGE, this.netherBridgeLootTable());
        lootTableBiConsumer.accept(BuiltInLootTables.PILLAGER_OUTPOST, this.pillagerOutpostLootTable());
        lootTableBiConsumer.accept(BuiltInLootTables.SHIPWRECK_MAP, this.shipwreckMapLootTable());
        lootTableBiConsumer.accept(BuiltInLootTables.SHIPWRECK_SUPPLY, this.shipwreckSupplyLootTable());
        lootTableBiConsumer.accept(BuiltInLootTables.SHIPWRECK_TREASURE, this.shipwreckTreasureLootTable());
        lootTableBiConsumer.accept(
        ...
        lootTableBiConsumer.accept(BuiltInLootTables.STRONGHOLD_CORRIDOR, this.strongholdCorridorLootTable());
        lootTableBiConsumer.accept(
        ...
        lootTableBiConsumer.accept(BuiltInLootTables.STRONGHOLD_LIBRARY, this.strongholdLibraryLootTable());
        lootTableBiConsumer.accept(
        ...
        lootTableBiConsumer.accept(BuiltInLootTables.WOODLAND_MANSION, this.woodlandMansionLootTable());
        lootTableBiConsumer.accept(
                        ...
                        .add(
                            LootItem.lootTableItem(Items.BOOK)
                                ...
                                .apply(
                                    new EnchantRandomlyFunction.Builder()
                                        .withOneOf(
                                            HolderSet.direct(registryLookup.getOrThrow(Enchantments.BREACH), registryLookup.getOrThrow(Enchantments.DENSITY))
                                        )
                                )
                        )
                        .add(
        ...
        this.spawnerLootTables(lootTableBiConsumer);
    }

    public void spawnerLootTables(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
        HolderLookup.RegistryLookup<Enchantment> registryLookup = this.registries.lookupOrThrow(Registries.ENCHANTMENT);
        lootTableBiConsumer.accept(
