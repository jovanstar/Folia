...
public class FriendlyByteBuf extends ByteBuf {
    ...
    public BlockHitResult readBlockHitResult() {
        ...
        return new BlockHitResult(new Vec3((double) blockposition.getX() + (double) f, (double) blockposition.getY() + (double) f1, (double) blockposition.getZ() + (double) f2), enumdirection, blockposition, flag, flag1);
    }
    ...
    public static int readContainerId(ByteBuf buf) {
    ...
    public static void writeContainerId(ByteBuf buf, int syncId) {
        VarInt.write(buf, syncId);
    }

    public void writeContainerId(int syncId) {
        FriendlyByteBuf.writeContainerId(this.source, syncId);
    }
