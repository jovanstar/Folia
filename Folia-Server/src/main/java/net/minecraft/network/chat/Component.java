...
public interface Component extends Message, FormattedText, Iterable<Component> { // CraftBukkit
    ...
    static MutableComponent score(SelectorPattern selector, String objective) {
        return MutableComponent.create(new ScoreContents(Either.left(selector), objective));
    }
    ...
    static MutableComponent selector(SelectorPattern selector, Optional<Component> separator) {
        return MutableComponent.create(new SelectorContents(selector, separator));
    }
