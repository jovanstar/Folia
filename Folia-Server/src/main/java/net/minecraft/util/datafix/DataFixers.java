...
public class DataFixers {
    ...
    private static final Result DATA_FIXER = DataFixers.createFixerUpper();
    ...
    public static CompletableFuture<?> optimize(Set<TypeReference> requiredTypes) {
        if (requiredTypes.isEmpty()) {
            ...
            return DataFixers.DATA_FIXER.optimize(requiredTypes, executorservice);
        }
    }
    ...
    private static void addFixers(DataFixerBuilder builder) {
        ...
        builder.addFixer(new NamedEntityFix(schema57, false, "Command block block entity custom name fix", References.BLOCK_ENTITY, "minecraft:command_block") {
            ...
            protected Typed<?> fix(Typed<?> inputTyped) {
                return inputTyped.update(DSL.remainderFinder(), EntityCustomNameToComponentFix::fixTagCustomName);
            }
        });
        ...
        builder.addFixer(new NamespacedTypeRenameFix(schema94, "Rename sugar recipe", References.RECIPE, DataFixers.createRenamer("minecraft:sugar", "minecraft:sugar_from_sugar_cane")));
        ...
        Schema schema118 = builder.addSchema(2538, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new LevelLegacyWorldGenSettingsFix(schema118));
        Schema schema119 = builder.addSchema(2550, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema121 = builder.addSchema(2552, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new NamespacedTypeRenameFix(schema121, "Nether biome rename", References.BIOME, DataFixers.createRenamer("minecraft:nether", "minecraft:nether_wastes")));
        Schema schema122 = builder.addSchema(2553, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new NamespacedTypeRenameFix(schema122, "Biomes fix", References.BIOME, DataFixers.createRenamer(BiomeFix.BIOMES)));
        Schema schema123 = builder.addSchema(2558, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema126 = builder.addSchema(2679, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new CauldronRenameFix(schema126, false));
        Schema schema127 = builder.addSchema(2680, DataFixers.SAME_NAMESPACED);

        builder.addFixer(ItemRenameFix.create(schema127, "Renamed grass path item to dirt path", DataFixers.createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
        builder.addFixer(BlockRenameFix.create(schema127, "Renamed grass path block to dirt path", DataFixers.createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
        ...
        Schema schema133 = builder.addSchema(2693, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema135 = builder.addSchema(2700, DataFixers.SAME_NAMESPACED);

        builder.addFixer(BlockRenameFix.create(schema135, "Renamed cave vines blocks", DataFixers.createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
        Schema schema136 = builder.addSchema(2701, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new SavedDataFeaturePoolElementFix(schema136));
        Schema schema137 = builder.addSchema(2702, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema140 = builder.addSchema(2710, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new StatsRenameFix(schema140, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time")));
        Schema schema141 = builder.addSchema(2717, DataFixers.SAME_NAMESPACED);

        builder.addFixer(ItemRenameFix.create(schema141, "Rename azalea_leaves_flowers", DataFixers.createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        builder.addFixer(BlockRenameFix.create(schema141, "Rename azalea_leaves_flowers items", DataFixers.createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        Schema schema142 = builder.addSchema(2825, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema145 = builder.addSchema(2833, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema145));
        Schema schema146 = builder.addSchema(2838, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new NamespacedTypeRenameFix(schema146, "Caves and Cliffs biome renames", References.BIOME, DataFixers.createRenamer(CavesAndCliffsRenames.RENAMES)));
        Schema schema147 = builder.addSchema(2841, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema149 = builder.addSchema(2843, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new OverreachingTickFix(schema149));
        builder.addFixer(new NamespacedTypeRenameFix(schema149, "Remove Deep Warm Ocean", References.BIOME, DataFixers.createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
        Schema schema150 = builder.addSchema(2846, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new AdvancementsRenameFix(schema150, false, "Rename some C&C part 2 advancements", DataFixers.createRenamer(ImmutableMap.of("minecraft:husbandry/play_jukebox_in_meadows", "minecraft:adventure/play_jukebox_in_meadows", "minecraft:adventure/caves_and_cliff", "minecraft:adventure/fall_from_world_height", "minecraft:adventure/ride_strider_in_overworld_lava", "minecraft:nether/ride_strider_in_overworld_lava"))));
        Schema schema151 = builder.addSchema(2852, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema151));
        Schema schema152 = builder.addSchema(2967, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new StructureSettingsFlattenFix(schema152));
        Schema schema153 = builder.addSchema(2970, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema155 = builder.addSchema(3077, DataFixers.SAME_NAMESPACED);
        ...
        Objects.requireNonNull(int2objectopenhashmap);
        builder.addFixer(new EntityVariantFix(schema162, "Change frog variant type", typereference, "minecraft:frog", "Variant", int2objectopenhashmap::get));
        Schema schema163 = builder.addSchema(3090, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new EntityFieldsRenameFix(schema163, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
        Schema schema164 = builder.addSchema(3093, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new EntityGoatMissingStateFix(schema164));
        Schema schema165 = builder.addSchema(3094, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new GoatHornIdFix(schema165));
        Schema schema166 = builder.addSchema(3097, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema167 = builder.addSchema(3108, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new BlendingDataRemoveFromNetherEndFix(schema167));
        Schema schema168 = builder.addSchema(3201, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema172 = builder.addSchema(3209, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new ItemStackSpawnEggFix(schema172, false, "minecraft:pig_spawn_egg"));
        Schema schema173 = builder.addSchema(3214, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new OptionsAmbientOcclusionFix(schema173));
        Schema schema174 = builder.addSchema(3319, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new OptionsAccessibilityOnboardFix(schema174));
        Schema schema175 = builder.addSchema(3322, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema182 = builder.addSchema(3440, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new NamespacedTypeRenameFix(schema182, "Replace experimental 1.20 overworld", References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, DataFixers.createRenamer("minecraft:overworld_update_1_20", "minecraft:overworld")));
        ...
        Schema schema196 = builder.addSchema(3692, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema198 = builder.addSchema(3800, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema199 = builder.addSchema(3803, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new RenameEnchantmentsFix(schema199, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
        ...
        Schema schema201 = builder.addSchema(3807, 1, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema205 = builder.addSchema(3809, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new ChestedHorsesInventoryZeroIndexingFix(schema205));
        Schema schema206 = builder.addSchema(3812, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new FixWolfHealth(schema206));
        Schema schema207 = builder.addSchema(3813, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new BlockPosFormatAndRenamesFix(schema207));
        Schema schema208 = builder.addSchema(3814, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new AttributesRenameLegacy(schema208, "Rename jump strength attribute", DataFixers.createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
        ...
        Schema schema211 = builder.addSchema(3818, 1, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new BannerPatternFormatFix(schema211));
        Schema schema212 = builder.addSchema(3818, 2, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema216 = builder.addSchema(3818, 6, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new AreaEffectCloudPotionFix(schema216));
        Schema schema217 = builder.addSchema(3820, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema219 = builder.addSchema(3828, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new EmptyItemInVillagerTradeFix(schema219));
        Schema schema220 = builder.addSchema(3833, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema222 = builder.addSchema(3939, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new FeatureFlagRemoveFix(schema222, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
        Schema schema223 = builder.addSchema(3943, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new OptionsMenuBlurrinessFix(schema223));
        Schema schema224 = builder.addSchema(3945, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new AttributeModifierIdFix(schema224));
        builder.addFixer(new JukeboxTicksSinceSongStartedFix(schema224));
        Schema schema225 = builder.addSchema(4054, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new OminousBannerRarityFix(schema225));
        Schema schema226 = builder.addSchema(4055, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new AttributeIdPrefixFix(schema226));
        Schema schema227 = builder.addSchema(4057, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema229 = builder.addSchema(4061, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new TrialSpawnerConfigInRegistryFix(schema229));
        Schema schema230 = builder.addSchema(4064, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema232 = builder.addSchema(4068, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema241 = builder.addSchema(4185, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new BlendingDataFix(schema241));
        Schema schema242 = builder.addSchema(4187, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new EntityAttributeBaseValueFix(schema242, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (d0) -> {
            return d0 == 48.0D ? 16.0D : d0;
        }));
        builder.addFixer(new EntityAttributeBaseValueFix(schema242, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (d0) -> {
            return d0 == 48.0D ? 16.0D : d0;
        }));
        builder.addFixer(new EntityAttributeBaseValueFix(schema242, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (d0) -> {
            return d0 == 48.0D ? 16.0D : d0;
        }));
        builder.addFixer(new EntityAttributeBaseValueFix(schema242, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (d0) -> {
            return d0 == 40.0D ? 16.0D : d0;
        }));
        builder.addFixer(new EntityAttributeBaseValueFix(schema242, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (d0) -> {
            return d0 == 16.0D ? 12.0D : d0;
        }));
        builder.addFixer(new EntityAttributeBaseValueFix(schema242, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (d0) -> {
            return d0 == 16.0D ? 24.0D : d0;
        }));
    }

    private static UnaryOperator<String> createRenamerNoNamespace(Map<String, String> replacements) {
        return (s) -> {
    ...
    private static UnaryOperator<String> createRenamer(Map<String, String> replacements) {
        return (s) -> {
            return (String) replacements.getOrDefault(NamespacedSchema.ensureNamespaced(s), s);
        };
    }

    private static UnaryOperator<String> createRenamer(String old, String current) {
        return (s2) -> {
            return Objects.equals(NamespacedSchema.ensureNamespaced(s2), old) ? current : s2;
        };
    }
}
