...
public class ServerFunctionManager {
    ...
    private void postReload(ServerFunctionLibrary loader) {
        this.ticking = List.copyOf(loader.getTag(ServerFunctionManager.TICK_FUNCTION_TAG));
    ...
    public List<CommandFunction<CommandSourceStack>> getTag(ResourceLocation id) {
