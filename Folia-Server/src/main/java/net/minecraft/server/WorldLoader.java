        ...
        try {
            ...
            return ReloadableServerResources.loadResources(
                ...
                .thenApplyAsync(dataPackContents -> {
                    dataPackContents.updateStaticRegistryTags();
                    return saveApplierFactory.create(closeableResourceManager, dataPackContents, layeredRegistryAccess2, dataLoadOutput.cookie);
                }, applyExecutor);
